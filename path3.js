...
function shareMessage() {
    // 공유할 내용을 여기에 추가
    var cardTitle = document.querySelector('.card-title1').textContent;
    var cardDate = document.querySelector('.card-date1').textContent;
    var cardDetail = document.querySelector('.card-detail1').textContent;
